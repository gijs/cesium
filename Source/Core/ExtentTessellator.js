...
define([
    ...
    ExtentTessellator._computeVerticesFromTerrain = function(description) {
        var desc = description || {};

        var terrain = desc.terrain;
        var extent = desc.extent.clone();
        var boundExtent = desc.boundaryExtent;
        var ellipsoid = desc.ellipsoid;
        var granularity = desc.granularity;
        ...
        var numCols = Math.round((boundExtent.east - boundExtent.west) / granularity);
    ...
    ExtentTessellator.computeBuffersFromTerrain = function(description) {
        var desc = description || {};
        ...
        ExtentTessellator._computeVerticesFromTerrain(desc);
